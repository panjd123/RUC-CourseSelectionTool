...
有人 [#10](https://github.com/panjd123/RUC-CourseSelectionTool/issues/10) 提到教务处注意到了抢课脚本，请自行判断并合理使用这个软件，当你的频率够低时这只是个自动化软件，且你发送的请求在服务器看来和手点没差。脚本默认的速度很慢，不应该对服务器产生压力。**如果你不理解这个脚本的原理，你不应该使用这个脚本。**
